...
- Creating your first schema and migration
- Running typed queries from your server code

If you want a fast, practical entry point to Prisma, this post is a good baseline.
